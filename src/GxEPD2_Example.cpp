...
// statements (display.epd2.panel == constant),
...
void setup_example() {
  ...
  delay(100);
  SPI.begin(18, -1, 17, 15); // SCK, MISO, MOSI, SS
...
void deepSleepTestPartialUpdate() {
  if (display.epd2.panel != GxEPD2::GDEY075T7)
...
void drawBitmaps200x200() {
  ...
  // controller
  display.epd2.writeScreenBufferAgain(); // use default for white
  display.epd2.writeImageAgain(bitmaps[0], int16_t(0), 0, 200, 200, false,
                               mirror_y, true);
  display.epd2.writeImageAgain(
      bitmaps[0], int16_t(int16_t(display.epd2.WIDTH) - 200),
      int16_t(display.epd2.HEIGHT) - 200, 200, 200, false, mirror_y, true);
  delay(2000);
}
#endif
...
void drawBitmaps128x250() {
  ...
  const unsigned char *bitmaps[] = {Bitmap128x250_1, logo128x250, first128x250,
                                    second128x250, third128x250};
#endif
  if ((display.epd2.WIDTH == 128) && (display.epd2.HEIGHT == 250) &&
      !display.epd2.hasColor) {
    bool m = display.mirror(true);
    for (uint16_t i = 0; i < sizeof(bitmaps) / sizeof(char *); i++) {
      display.firstPage();
...
#endif
  if ((display.epd2.WIDTH == 168) && (display.epd2.HEIGHT == 384) &&
      !display.epd2.hasColor) {
...
void drawBitmaps152x296() {
  ...
  const unsigned char *bitmaps[] = {Bitmap152x296_1, Bitmap152x296_2,
                                    Bitmap152x296_3};
#endif
  if ((display.epd2.WIDTH == 152) && (display.epd2.HEIGHT == 296) &&
      !display.epd2.hasColor) {
    for (uint16_t i = 0; i < sizeof(bitmaps) / sizeof(char *); i++) {
      display.firstPage();
      do {
...
void drawBitmaps240x320() {
  ...
  const unsigned char *bitmaps[] = {Bitmap240x320_1, Bitmap240x320_2};
#endif
  if ((display.epd2.WIDTH == 240) && (display.epd2.HEIGHT == 320) &&
      !display.epd2.hasColor) {
    for (uint16_t i = 0; i < sizeof(bitmaps) / sizeof(char *); i++) {
      display.firstPage();
      do {
...
void drawBitmaps240x416() {
  ...
  const unsigned char *bitmaps[] = {Bitmap240x460_1, Bitmap240x460_2,
                                    Bitmap240x460_3};
#endif
  if ((display.epd2.WIDTH == 240) && (display.epd2.HEIGHT == 416) &&
      !display.epd2.hasColor) {
    for (uint16_t i = 0; i < sizeof(bitmaps) / sizeof(char *); i++) {
      display.firstPage();
      do {
...
void drawBitmaps648x480() {
  ...
  const unsigned char *bitmaps[] = {}; // not enough code space
#endif
  if ((display.epd2.WIDTH == 648) && (display.epd2.HEIGHT == 480) &&
      !display.epd2.hasColor) {
    for (uint16_t i = 0; i < sizeof(bitmaps) / sizeof(char *); i++) {
      display.firstPage();
      do {
...
void drawBitmaps800x276() {
  if ((display.epd2.WIDTH == 792) && (display.epd2.HEIGHT == 272) &&
      !display.epd2.hasColor) {
    display.drawImage(Bitmap800x276_1, 0, 0, 800, 272, true, false, true);
    delay(2000);
    display.drawImage(Bitmap800x276_2, 0, 0, 800, 272, true, false, true);
    delay(2000);
    display.drawImage(Bitmap800x276_3, 0, 0, 800, 272, true, false, true);
    delay(2000);
    display.clearScreen();
    ...
    for (int16_t i = 0; i < 5; i++) {
      for (int16_t j = 0; j < 5; j++) {
        display.writeImagePart(Bitmap800x276_1, i * wp, j * hp, 800, 272,
                               i * wp, j * hp, wp, hp, true, false, true);
        display.refresh(true);
        display.epd2.writeImagePartAgain(Bitmap800x276_1, i * wp, j * hp, 800,
...
void drawBitmaps800x480() {
  ...
  if ((display.epd2.WIDTH == 800) && (display.epd2.HEIGHT == 480) &&
    ...
    if ((display.epd2.panel == GxEPD2::GDEW075T7) ||
        (display.epd2.panel == GxEPD2::GDEY075T7)) {
  ...
  if (display.epd2.panel == GxEPD2::GDEP073E01) {
    ...
    for (int16_t k = 0; k < 3; k++) {
      ...
      for (int16_t i = 0; i < 5; i++) {
        for (int16_t j = 0; j < 5; j++) {
          if ((n++ % 2) || (k == 2)) {
            display.epd2.writeImagePart(Bitmap800x480_1, 0, i * wp, j * hp, 800,
...
void drawBitmaps960x640() {
  if ((display.epd2.WIDTH == 960) && (display.epd2.HEIGHT == 640) &&
      !display.epd2.hasColor) {
    display.drawImage(Bitmap960x640_1, 0, 0, 960, 640, false, true, true);
    delay(5000);
    display.drawImage(Bitmap960x640_2, 0, 0, 960, 640, false, true, true);
    delay(5000);
    display.drawImage(Bitmap960x640_3, 0, 0, 960, 640, false, true, true);
    delay(5000);
  }
}
#endif
...
void drawBitmaps960x680() {
  if ((display.epd2.WIDTH == 960) && (display.epd2.HEIGHT == 680) &&
      !display.epd2.hasColor) {
    display.drawImage(Bitmap960x680_1, 0, 0, 960, 680, false, true, true);
    delay(5000);
    display.drawImage(Bitmap960x680_2, 0, 0, 960, 680, false, true, true);
    delay(5000);
  }
}
#endif
...
void drawBitmaps800x600() {
  ...
  if ((display.epd2.panel == GxEPD2::ED060SCT) ||
      (display.epd2.panel == GxEPD2::ED060KC1) ||
      (display.epd2.panel == GxEPD2::ED078KC2)) {
...
void drawBitmaps1304x984() {
  if (display.epd2.panel == GxEPD2::GDEW1248T3) {
    display.drawImage(Bitmap1304x984, 0, 0, display.epd2.WIDTH,
                      display.epd2.HEIGHT, false, false, true);
  }
}
#endif
...
void drawBitmaps1360x480() {
  if (display.epd2.panel == GxEPD2::GDEM1085T51) {
    display.drawImage(Bitmap1360x480_1, 0, 0, display.epd2.WIDTH,
                      display.epd2.HEIGHT, false, false, true);
    delay(2000);
    display.drawImage(Bitmap1360x480_p1, 0, 0, display.epd2.WIDTH,
                      display.epd2.HEIGHT, false, false, true);
    delay(1000);
    display.drawImage(Bitmap1360x480_p2, 0, 0, display.epd2.WIDTH,
                      display.epd2.HEIGHT, false, false, true);
    delay(1000);
    display.drawImage(Bitmap1360x480_p3, 0, 0, display.epd2.WIDTH,
                      display.epd2.HEIGHT, false, false, true);
    delay(1000);
    display.clearScreen();
    int16_t wp = display.epd2.WIDTH / 5;
    ...
    for (int16_t i = 0; i < 5; i++) {
      for (int16_t j = 0; j < 5; j++) {
        display.writeImagePart(Bitmap1360x480_1, i * wp, j * hp, 1360, 480,
...
void drawBitmaps3c128x250() {
  if ((display.epd2.WIDTH == 128) && (display.epd2.HEIGHT == 250) &&
    ...
    do {
      display.fillScreen(GxEPD_WHITE);
      display.drawInvertedBitmap(0, 0, Bitmap3c128x250_1_black, 128, 250,
                                 GxEPD_BLACK);
      display.drawInvertedBitmap(0, 0, Bitmap3c128x250_1_red, 128, 250,
                                 GxEPD_RED);
    } while (display.nextPage());
    delay(2000);
#if !defined(__AVR)
    ...
    do {
      display.fillScreen(GxEPD_WHITE);
      display.drawInvertedBitmap(0, 0, Bitmap3c128x250_2_black, 128, 250,
                                 GxEPD_BLACK);
...
void drawBitmaps3c128x296() {
  ...
  if ((display.epd2.WIDTH == 128) && (display.epd2.HEIGHT == 296) &&
    ...
    for (uint16_t i = 0; i < sizeof(bitmap_pairs) / sizeof(bitmap_pair); i++) {
      ...
      do {
        display.fillScreen(GxEPD_WHITE);
        display.drawInvertedBitmap(0, 0, bitmap_pairs[i].black, 128, 296,
                                   GxEPD_BLACK);
        if (bitmap_pairs[i].red == WS_Bitmap3c128x296_red) {
          display.drawInvertedBitmap(0, 0, bitmap_pairs[i].red, 128, 296,
                                     GxEPD_RED);
        } else
  ...
  if (display.epd2.panel == GxEPD2::GDEY0266Z90) {
    ...
    for (uint16_t i = 0; i < sizeof(bitmap_pairs) / sizeof(bitmap_pair); i++) {
      ...
      do {
        ...
        display.drawInvertedBitmap(0, 0, bitmap_pairs[i].red, 152, 296,
                                   GxEPD_RED);
      } while (display.nextPage());
      delay(2000);
    }
...
void drawBitmaps3c648x480() {
  ...
  if ((display.epd2.panel == GxEPD2::GDEW0583Z83) ||
      (display.epd2.panel == GxEPD2::GDEQ0583Z31)) {
    for (uint16_t i = 0; i < sizeof(bitmap_pairs) / sizeof(bitmap_pair); i++) {
      display.firstPage();
      do {
        display.fillScreen(GxEPD_WHITE);
...
void drawBitmaps3c800x276() {
  if ((display.epd2.WIDTH == 792) && (display.epd2.HEIGHT == 272) &&
      display.epd2.hasColor) {
    display.drawImage(Bitmap3c800x276_black_1, Bitmap3c800x276_red_1, 0, 0, 800,
                      272, true, false, true);
    delay(2000);
    display.drawImage(Bitmap3c800x276_black_2, Bitmap3c800x276_red_2, 0, 0, 800,
                      272, true, false, true);
    delay(2000);
    int16_t wp = display.epd2.WIDTH / 5;
    int16_t hp = display.epd2.HEIGHT / 5;
...
void drawBitmaps3c800x480() {
  ...
  if ((display.epd2.panel == GxEPD2::GDEW075Z08) ||
      (display.epd2.panel == GxEPD2::GDEY075Z08)) {
    for (uint16_t i = 0; i < sizeof(bitmap_pairs) / sizeof(bitmap_pair); i++) {
      display.firstPage();
      do {
        display.fillScreen(GxEPD_WHITE);
...
void drawBitmaps3c880x528() {
  ...
  if (display.epd2.panel == GxEPD2::GDEH075Z90) {
    ...
    for (uint16_t i = 0; i < sizeof(bitmap_pairs) / sizeof(bitmap_pair); i++) {
      ...
      do {
        display.fillScreen(GxEPD_WHITE);
        display.drawInvertedBitmap(0, 0, bitmap_pairs[i].black, 880, 528,
                                   GxEPD_BLACK);
        display.drawInvertedBitmap(0, 0, bitmap_pairs[i].red, 880, 528,
                                   GxEPD_RED);
      } while (display.nextPage());
      delay(2000);
    }
...
void drawBitmaps3c960x640() {
  if ((display.epd2.WIDTH == 960) && (display.epd2.HEIGHT == 640) &&
      display.epd2.hasColor) {
    display.drawImage(Bitmap3c960x640_black, Bitmap3c960x640_red, 0, 0, 960,
...
void drawBitmaps3c960x680() {
  if ((display.epd2.WIDTH == 960) && (display.epd2.HEIGHT == 680) &&
      display.epd2.hasColor) {
    display.drawImage(Bitmap3c960x680_black, Bitmap3c960x680_red, 0, 0, 960,
                      680, false, true, true);
  }
  delay(2000);
}
...
void drawBitmaps3c1304x984() {
  if (display.epd2.panel == GxEPD2::GDEY1248Z51) {
    // display.drawImage(Bitmap3c1304x984_black, Bitmap3c1304x984_red, 0, 0,
    // 1304, 984, false, false, true);
    display.writeImage(0, Bitmap3c1304x984_red, 0, 0, 1304, 984, true, false,
                       true); // red bitmap is inverted
    display.drawImage(Bitmap3c1304x984_black, 0, 0, 0, 1304, 984, true, false,
...
void drawBitmaps4c168x168() {
  if ((display.epd2.panel == GxEPD2::Waveshare437inch4color) ||
      (display.epd2.panel == GxEPD2::Waveshare3inch4color) ||
      (display.epd2.panel == GxEPD2::GDEY0579F51) ||
      (display.epd2.panel == GxEPD2::GDEY116F51)) {
    display.drawNative(WS_Bitmap4c168x168, 0, (display.epd2.WIDTH - 168) / 2,
                       (display.epd2.HEIGHT - 168) / 2, 168, 168, false, false,
                       true);
    delay(5000);
  }
}
...
void drawBitmaps4c168x400() {
  if (display.epd2.panel == GxEPD2::Waveshare3inch4color) {
    display.drawNative(WS_Bitmap4c168x400, 0, (display.epd2.WIDTH - 168) / 2,
                       (display.epd2.HEIGHT - 400) / 2, 168, 400, false, false,
                       true);
    delay(5000);
  }
}
...
void drawBitmaps4c168x384() {
  if (display.epd2.panel == GxEPD2::GDEY029F51H) {
    display.drawNative(Bitmap4c168x384, 0, (display.epd2.WIDTH - 168) / 2,
                       (display.epd2.HEIGHT - 384) / 2, 168, 384, false, false,
                       true);
    delay(5000);
  }
}
...
void drawBitmaps4c184x360() {
  if (display.epd2.panel == GxEPD2::GDEY0266F51H) {
    display.drawNative(Bitmap4c184x360, 0, (display.epd2.WIDTH - 184) / 2,
                       (display.epd2.HEIGHT - 360) / 2, 184, 360, false, false,
                       true);
    delay(5000);
  }
}
...
void drawBitmaps4c184x384() {
  if (display.epd2.panel == GxEPD2::GDEM035F51) {
    display.drawNative(Bitmap4c184x384, 0, (display.epd2.WIDTH - 184) / 2,
                       (display.epd2.HEIGHT - 384) / 2, 184, 384, true, false,
                       true);
    delay(5000);
  }
}
...
void drawBitmaps4c400x300() {
  if (display.epd2.panel == GxEPD2::GDEY0420F51) {
    display.drawNative(Bitmap4c400x300, 0, (display.epd2.WIDTH - 400) / 2,
                       (display.epd2.HEIGHT - 300) / 2, 400, 300, false, false,
                       true);
    delay(5000);
  }
}
...
void drawBitmaps4c800x480() {
  if ((display.epd2.panel == GxEPD2::GDEM0397F81) ||
      (display.epd2.panel == GxEPD2::GDEM075F52)) {
    display.drawNative(Bitmap4c800x480_1, 0, (display.epd2.WIDTH - 800) / 2,
                       (display.epd2.HEIGHT - 480) / 2, 800, 480, true, false,
                       true);
    delay(5000);
    display.drawNative(Bitmap4c800x480_2, 0, (display.epd2.WIDTH - 800) / 2,
                       (display.epd2.HEIGHT - 480) / 2, 800, 480, true, false,
                       true);
    delay(5000);
  }
...
void drawBitmaps4c960x640() {
  if (display.epd2.panel == GxEPD2::GDEY116F51) {
    display.drawNative(Bitmap4c960x640, 0, (display.epd2.WIDTH - 960) / 2,
                       (display.epd2.HEIGHT - 640) / 2, 960, 640, true, false,
                       true);
    delay(5000);
  }
}
...
void drawBitmaps4c792x272() {
  if (display.epd2.panel == GxEPD2::GDEY0579F51) {
    display.drawNative(Bitmap4c792x272, 0, (display.epd2.WIDTH - 792) / 2,
                       (display.epd2.HEIGHT - 272) / 2, 792, 272, true, false,
                       true);
    delay(5000);
    ...
    for (int16_t k = 0; k < 3; k++) {
      ...
      for (int16_t i = 0; i < 5; i++) {
        for (int16_t j = 0; j < 5; j++) {
          if ((n++ % 2) || (k == 2)) {
            display.epd2.writeNativePart(Bitmap4c792x272, 0, i * wp, j * hp,
...
void drawBitmaps7c600x448() {
  if (display.epd2.panel == GxEPD2::GDEP0565D90) {
    display.epd2.drawDemoBitmap(Bitmap7c600x448, 0, 0, 0, 600, 448, 1, false,
                                true);
    delay(5000);
  }
}
...
void drawBitmaps7c192x143() {
  if (display.epd2.panel == GxEPD2::ACeP565) {
    display.drawNative(WS_Bitmap7c192x143, 0, (display.epd2.WIDTH - 192) / 2,
                       (display.epd2.HEIGHT - 143) / 2, 192, 143, false, false,
                       true);
    delay(5000);
  }
}
...
void drawBitmaps7c800x480() {
  if ((display.epd2.panel == GxEPD2::GDEY073D46) ||
      ...
      (display.epd2.panel == GxEPD2::GDEP0565D90) ||
      (display.epd2.panel == GxEPD2::GDEP073E01)) {
    display.epd2.drawDemoBitmap(Bitmap7c800x480, 0, 0, 0, 800, 480, 0, false,
                                true); // special format
    delay(5000);
    display.epd2.drawDemoBitmap(Bitmap7c800x480_2, 0, 0, 0, 800, 480, 1, false,
...
void drawBitmaps7c300x180() {
  if ((display.epd2.panel == GxEPD2::GDEY073D46) ||
      (display.epd2.panel == GxEPD2::ACeP730) ||
      (display.epd2.panel == GxEPD2::GDEP0565D90)) {
    display.drawNative(WS_Bitmap7c300x180, 0, (display.epd2.WIDTH - 300) / 2,
                       (display.epd2.HEIGHT - 180) / 2, 300, 180, false, false,
                       true);
    delay(5000);
  }
}
...
void draw7colorlines() {
  ...
  do {
    ...
    // display.drawPixel(0, y, GxEPD_BLACK); display.drawPixel(10, y,
    // GxEPD_GREEN); display.drawPixel(20, y, GxEPD_BLUE); display.drawPixel(30,
    // y, GxEPD_RED); display.drawPixel(40, y, GxEPD_YELLOW);
    // display.drawPixel(50, y, GxEPD_ORANGE);
...
void drawGraphics() {
  ...
  display.firstPage();
  do {
    display.drawRect(display.width() / 8, display.height() / 8,
                     display.width() * 3 / 4, display.height() * 3 / 4,
                     GxEPD_BLACK);
    display.drawLine(display.width() / 8, display.height() / 8,
                     display.width() * 7 / 8, display.height() * 7 / 8,
                     GxEPD_BLACK);
    display.drawLine(display.width() / 8, display.height() * 7 / 8,
                     display.width() * 7 / 8, display.height() / 8,
                     GxEPD_BLACK);
    display.drawCircle(display.width() / 2, display.height() / 2,
                       display.height() / 4, GxEPD_BLACK);
    display.drawPixel(display.width() / 4, display.height() / 2, GxEPD_BLACK);
    display.drawPixel(display.width() * 3 / 4, display.height() / 2,
                      GxEPD_BLACK);
  } while (display.nextPage());
  delay(1000);
}
