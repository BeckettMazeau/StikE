...
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS*/ 4, /*DC=*/ 5, /*RST=*/ 6, /*BUSY=*/ 8)); // Good Display ESP32E6-E01 board
...
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS*/ 15, /*DC=*/ 7, /*RST=*/ 6, /*BUSY=*/ 5)); // my suggested wiring and proto board
...
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS*/ 4, /*DC=*/ 5, /*RST=*/ 6, /*BUSY=*/ 8)); // my suggested wiring and proto board
